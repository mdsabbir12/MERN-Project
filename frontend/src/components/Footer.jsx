import imgtag from "../assets/Vector.png"
import imgapple from "../assets/frame.png"
export default function Footer() {
    return (
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full bg-green-700">
            <div className="flex flex-col md:flex-row items-start justify-between gap-40 py-10 border-b border-gray-500/30">
                
                <div className="max-w-96">
                    <img className="text-white w-[300px]" src={imgtag} alt="" />
            ...
            <p className="py-4 text-center text-xs md:text-sm text-white">
                Copyright © 2021-2025, ScapeSync. All Rights Reserved.
            </p>
        </footer>
    );
};